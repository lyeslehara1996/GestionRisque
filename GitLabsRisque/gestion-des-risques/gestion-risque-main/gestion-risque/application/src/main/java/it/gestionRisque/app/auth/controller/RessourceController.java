...
public class RessourceController {
	...
	public ResponseEntity<Permissions> savePermissions(@RequestBody Permissions permissions){
		try {
			...
			e.printStackTrace();
			return  new ResponseEntity("la permissions existe déja ", HttpStatus.BAD_REQUEST);
		}
	}
	
	
	@RequestMapping(value = "/permissions/addPermissionToRole",method = RequestMethod.POST)
	public ResponseEntity<?> addPermissionToRoles(Long id_Roles, Long id_Permissions){
